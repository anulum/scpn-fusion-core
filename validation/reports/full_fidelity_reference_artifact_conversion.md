...
- free_boundary_equilibrium (FreeGS/FreeGSNKE): FreeGSNKE baselines were converted as partial raw outputs, but strict FreeGS parity still needs coil-current sidecars, boundary/limiter metadata, axis/X-point data, and native psi comparison for the same public case
