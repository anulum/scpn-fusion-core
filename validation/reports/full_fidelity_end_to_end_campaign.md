...
| free_boundary_equilibrium_strict_parity | blocked_public_freegs_external_psi_ready_missing_native_same_case_comparison | True | False | FreeGS, FreeGSNKE | converged FreeGS/FreeGSNKE public nonlinear equilibrium output<br>native same-case free-boundary profile-source reconstruction<br>psi_N RMSE threshold against external output<br>axis/X-point/boundary containment and q-profile thresholds<br>grid convergence across public example resolutions |
