...
| aurora_strahl_grade_impurities | blocked_native_aurora_same_case_threshold_mismatch | True | True | Aurora | charge-state-resolved radial transport operator on evolved density<br>Aurora source/recycling/effective transport closure<br>native same-case Aurora threshold pass |
