...
def run_campaign(
    *,
    ...
    """Run constrained free-boundary scenario with physics guard margins."""
...
def generate_report(**kwargs: Any) -> dict[str, Any]:
    """Generate task 12 report and attach generation timestamp."""
...
def render_markdown(report: dict[str, Any]) -> str:
    """Render task 12 physics-margin safety outcomes into markdown."""
...
def main(argv: list[str] | None = None) -> int:
    """Run task 12 acceptance and save JSON/Markdown artifacts."""
    ...
    parser.add_argument(
        "--output-json",
        default=str(
            ROOT / "validation" / "reports" / "task12_free_boundary_physics_margin_safety.json"
        ),
    )
    parser.add_argument(
        "--output-md",
        default=str(
            ROOT / "validation" / "reports" / "task12_free_boundary_physics_margin_safety.md"
        ),
    )
