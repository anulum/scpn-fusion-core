...
def test_main_is_ascii_stdout_safe(tmp_path: Path, monkeypatch) -> None:
    ...
    gate = EfitNRMSEBenchmarkGate(
        ...
        gate_source_domain_required_solver_mode_counts={
            "profile_source_then_free_boundary_reconstruction_required": 1
        },
        ...
        rows=[
            {
                ...
                "free_boundary_external_coil_sidecar_present": False,
                "free_boundary_external_coil_data_available": False,
                "free_boundary_external_coil_count": 0,
                "free_boundary_external_coil_provenance": "",
                ...
                "operator_toroidal_current_trapezoidal_A": -8.69e6,
                ...
                "operator_current_trapezoidal_ratio_to_declared": 0.99885,
                ...
                "operator_current_trapezoidal_relative_error": 0.00115,
