...
def test_probe_rust_runtime_bindings_uses_available_bindings(
    ...
    setattr(fake, "scpn_dense_activations", lambda *_args, **_kwargs: None)
    setattr(fake, "scpn_marking_update", lambda *_args, **_kwargs: None)
    setattr(fake, "scpn_sample_firing", lambda *_args, **_kwargs: None)
