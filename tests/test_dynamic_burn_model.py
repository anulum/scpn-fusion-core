...
"""Pytest tests for the self-consistent dynamic burn model (DynamicBurnModel)."""
...
from scpn_fusion.core.dynamic_burn_model import BurnPhysicsError, DynamicBurnModel
