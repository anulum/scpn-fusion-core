...
def build_report() -> dict[str, Any]:
    ...
    return {
        ...
        "claim_boundary": (
            "Local non-isolated regression evidence for supplied-current pulsed-compression "
            "dynamics wired to the Ono non-adiabatic flux carrier. Slough Fig. 5 parity "
            "remains blocked until a public digitised reference trajectory exists."
        ),
        "environment": {
