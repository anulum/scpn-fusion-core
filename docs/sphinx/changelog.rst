...
- Adds the M-4 safety-shield + constrained-PPO policy, the F-7 TGLF transport surrogate, the M-1 Petri→SNN interlock with proof hash, fastest-first FNO/surrogate-MPC/Fokker-Planck dispatch tiers, the per-surrogate UQ/OOD cards and T-2 safety traceability matrix (fail-closed drift guards), the F-5 PB-KBM pedestal tier, and the F-1 Solov'ev exact suite.
