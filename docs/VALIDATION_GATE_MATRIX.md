...
|---|---|---|
| `release` | Version/claims integrity, disruption data provenance + split + calibration holdout checks, notebook quality gate, Task 5/6 threshold smoke, strict typing; excludes experimental tests from global pytest runs. | `python tools/run_python_preflight.py --gate release` |
