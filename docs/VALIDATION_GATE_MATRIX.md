...
|---|---|---|
| `release` | Version/claims integrity, notebook quality gate, Task 5/6 threshold smoke, strict typing; excludes experimental tests from global pytest runs. | `python tools/run_python_preflight.py --gate release` |
