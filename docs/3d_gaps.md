...
- Execution queue authority remains local coordination notes under `.coordination/` and is not mirrored in public-facing docs.
...
- Includes the GyroSwin-like turbulence surrogate benchmark, the TORAX-hybrid
  ...
  validation, the liquid-metal TEMHD divertor validation, `GMVR-03`, the
  NSTX-U/SPARC digital-twin
...
- Delivered advanced v1 lanes (synthetic scope): the GyroSwin-like turbulence
  ...
  divertor validation, `GMVR-03`, the NSTX-U/SPARC digital-twin ingestion
  campaign, the
...
Execution queue is defined in local `.coordination/` operational notes.
Advanced-task RFC tracking is maintained in local coordination notes and is not mirrored in public docs.
