...
- Generated at: `2026-04-29T16:42:19.155087+00:00`
...
### 1. [P0] Harden `src/scpn_fusion/core/integrated_transport_solver.py`
...
### 2. [P0] Harden `src/scpn_fusion/core/tglf_interface.py`
...
### 3. [P0] Harden `src/scpn_fusion/io/tokamak_archive.py`
...
### 4. [P1] Harden `src/scpn_fusion/control/burn_controller.py`
...
### 5. [P1] Harden `src/scpn_fusion/control/controller_tuning.py`
...
### 6. [P1] Harden `src/scpn_fusion/control/density_controller.py`
...
### 7. [P1] Harden `src/scpn_fusion/control/mu_synthesis.py`
...
### 8. [P1] Harden `src/scpn_fusion/control/realtime_efit.py`
...
### 9. [P1] Harden `src/scpn_fusion/core/alfven_eigenmodes.py`
...
### 10. [P1] Harden `src/scpn_fusion/core/disruption_sequence.py`
...
### 11. [P1] Harden `src/scpn_fusion/core/elm_model.py`
...
### 12. [P1] Harden `src/scpn_fusion/core/gk_eigenvalue.py`
...
### 13. [P1] Harden `src/scpn_fusion/core/gk_geometry.py`
...
### 14. [P1] Harden `src/scpn_fusion/core/gk_online_learner.py`
...
### 15. [P1] Harden `src/scpn_fusion/core/gk_species.py`
...
### 16. [P1] Harden `src/scpn_fusion/core/impurity_transport.py`
...
### 17. [P1] Harden `src/scpn_fusion/core/integrated_scenario.py`
...
### 18. [P1] Harden `src/scpn_fusion/core/lh_transition.py`
...
### 19. [P1] Harden `src/scpn_fusion/core/locked_mode.py`
...
### 20. [P1] Harden `src/scpn_fusion/core/momentum_transport.py`
...
### 21. [P1] Harden `src/scpn_fusion/core/neoclassical.py`
...
### 22. [P1] Harden `src/scpn_fusion/core/neural_turbulence.py`
...
### 23. [P1] Harden `src/scpn_fusion/core/plasma_wall_interaction.py`
...
### 24. [P1] Harden `src/scpn_fusion/core/stellarator_geometry.py`
...
### 25. [P1] Harden `src/scpn_fusion/core/vmec_lite.py`
