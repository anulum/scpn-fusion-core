...
- Generated at: `2026-04-29T16:05:14.127256+00:00`
...
### 1. [P0] Harden `src/scpn_fusion/core/integrated_transport_solver_model.py`
...
### 2. [P0] Harden `src/scpn_fusion/core/neural_transport.py`
...
### 3. [P0] Harden `src/scpn_fusion/control/nengo_snn_wrapper.py`
...
### 4. [P0] Harden `src/scpn_fusion/core/gk_nonlinear.py`
...
### 8. [P1] Harden `src/scpn_fusion/control/burn_controller.py`
...
### 9. [P1] Harden `src/scpn_fusion/control/controller_tuning.py`
...
### 10. [P1] Harden `src/scpn_fusion/control/density_controller.py`
...
### 11. [P1] Harden `src/scpn_fusion/control/mu_synthesis.py`
...
### 12. [P1] Harden `src/scpn_fusion/control/realtime_efit.py`
...
### 13. [P1] Harden `src/scpn_fusion/core/alfven_eigenmodes.py`
...
### 14. [P1] Harden `src/scpn_fusion/core/disruption_sequence.py`
...
### 15. [P1] Harden `src/scpn_fusion/core/elm_model.py`
...
### 16. [P1] Harden `src/scpn_fusion/core/gk_eigenvalue.py`
...
### 17. [P1] Harden `src/scpn_fusion/core/gk_geometry.py`
...
### 18. [P1] Harden `src/scpn_fusion/core/gk_online_learner.py`
...
### 19. [P1] Harden `src/scpn_fusion/core/gk_species.py`
...
### 20. [P1] Harden `src/scpn_fusion/core/impurity_transport.py`
...
### 21. [P1] Harden `src/scpn_fusion/core/integrated_scenario.py`
...
### 22. [P1] Harden `src/scpn_fusion/core/lh_transition.py`
...
### 23. [P1] Harden `src/scpn_fusion/core/locked_mode.py`
...
### 24. [P1] Harden `src/scpn_fusion/core/momentum_transport.py`
...
### 25. [P1] Harden `src/scpn_fusion/core/neoclassical.py`
...
### 26. [P1] Harden `src/scpn_fusion/core/neural_turbulence.py`
...
### 27. [P1] Harden `src/scpn_fusion/core/plasma_wall_interaction.py`
...
### 28. [P1] Harden `src/scpn_fusion/core/stellarator_geometry.py`
...
### 29. [P1] Harden `src/scpn_fusion/core/vmec_lite.py`
