...
- Generated at: `2026-04-29T21:58:49.050696+00:00`
...
### 1. [P1] Harden `src/scpn_fusion/control/controller_tuning.py`
...
### 2. [P1] Harden `src/scpn_fusion/control/density_controller.py`
...
### 3. [P1] Harden `src/scpn_fusion/control/mu_synthesis.py`
...
### 4. [P1] Harden `src/scpn_fusion/control/realtime_efit.py`
...
### 5. [P1] Harden `src/scpn_fusion/core/alfven_eigenmodes.py`
...
### 6. [P1] Harden `src/scpn_fusion/core/disruption_sequence.py`
...
### 7. [P1] Harden `src/scpn_fusion/core/elm_model.py`
...
### 8. [P1] Harden `src/scpn_fusion/core/gk_eigenvalue.py`
...
### 9. [P1] Harden `src/scpn_fusion/core/gk_geometry.py`
...
### 10. [P1] Harden `src/scpn_fusion/core/gk_online_learner.py`
...
### 11. [P1] Harden `src/scpn_fusion/core/gk_species.py`
...
### 12. [P1] Harden `src/scpn_fusion/core/impurity_transport.py`
...
### 13. [P1] Harden `src/scpn_fusion/core/integrated_scenario.py`
...
### 14. [P1] Harden `src/scpn_fusion/core/lh_transition.py`
...
### 15. [P1] Harden `src/scpn_fusion/core/locked_mode.py`
...
### 16. [P1] Harden `src/scpn_fusion/core/momentum_transport.py`
...
### 17. [P1] Harden `src/scpn_fusion/core/neoclassical.py`
...
### 20. [P1] Harden `src/scpn_fusion/core/stellarator_geometry.py`
...
### 21. [P1] Harden `src/scpn_fusion/core/vmec_lite.py`
