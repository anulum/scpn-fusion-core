...
- Generated at: `2026-04-29T16:14:47.874372+00:00`
...
### 1. [P0] Harden `src/scpn_fusion/core/neural_transport.py`
...
### 2. [P0] Harden `src/scpn_fusion/control/nengo_snn_wrapper.py`
...
### 3. [P0] Harden `src/scpn_fusion/core/gk_nonlinear.py`
...
### 7. [P1] Harden `src/scpn_fusion/control/burn_controller.py`
...
### 8. [P1] Harden `src/scpn_fusion/control/controller_tuning.py`
...
### 9. [P1] Harden `src/scpn_fusion/control/density_controller.py`
...
### 10. [P1] Harden `src/scpn_fusion/control/mu_synthesis.py`
...
### 11. [P1] Harden `src/scpn_fusion/control/realtime_efit.py`
...
### 12. [P1] Harden `src/scpn_fusion/core/alfven_eigenmodes.py`
...
### 13. [P1] Harden `src/scpn_fusion/core/disruption_sequence.py`
...
### 14. [P1] Harden `src/scpn_fusion/core/elm_model.py`
...
### 15. [P1] Harden `src/scpn_fusion/core/gk_eigenvalue.py`
...
### 16. [P1] Harden `src/scpn_fusion/core/gk_geometry.py`
...
### 17. [P1] Harden `src/scpn_fusion/core/gk_online_learner.py`
...
### 18. [P1] Harden `src/scpn_fusion/core/gk_species.py`
...
### 19. [P1] Harden `src/scpn_fusion/core/impurity_transport.py`
...
### 20. [P1] Harden `src/scpn_fusion/core/integrated_scenario.py`
...
### 21. [P1] Harden `src/scpn_fusion/core/lh_transition.py`
...
### 22. [P1] Harden `src/scpn_fusion/core/locked_mode.py`
...
### 23. [P1] Harden `src/scpn_fusion/core/momentum_transport.py`
...
### 24. [P1] Harden `src/scpn_fusion/core/neoclassical.py`
...
### 25. [P1] Harden `src/scpn_fusion/core/neural_turbulence.py`
...
### 26. [P1] Harden `src/scpn_fusion/core/plasma_wall_interaction.py`
...
### 27. [P1] Harden `src/scpn_fusion/core/stellarator_geometry.py`
...
### 28. [P1] Harden `src/scpn_fusion/core/vmec_lite.py`
