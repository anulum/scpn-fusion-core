...
- Generated at: `2026-04-29T16:24:37.303633+00:00`
...
### 1. [P0] Harden `src/scpn_fusion/control/nengo_snn_wrapper.py`
...
### 2. [P0] Harden `src/scpn_fusion/core/gk_nonlinear.py`
...
### 3. [P0] Harden `src/scpn_fusion/core/integrated_transport_solver.py`
...
### 4. [P0] Harden `src/scpn_fusion/core/tglf_interface.py`
...
### 5. [P0] Harden `src/scpn_fusion/io/tokamak_archive.py`
...
### 6. [P1] Harden `src/scpn_fusion/control/burn_controller.py`
...
### 7. [P1] Harden `src/scpn_fusion/control/controller_tuning.py`
...
### 14. [P1] Harden `src/scpn_fusion/core/gk_eigenvalue.py`
...
### 15. [P1] Harden `src/scpn_fusion/core/gk_geometry.py`
...
### 16. [P1] Harden `src/scpn_fusion/core/gk_online_learner.py`
...
### 17. [P1] Harden `src/scpn_fusion/core/gk_species.py`
...
### 18. [P1] Harden `src/scpn_fusion/core/impurity_transport.py`
...
### 19. [P1] Harden `src/scpn_fusion/core/integrated_scenario.py`
...
### 20. [P1] Harden `src/scpn_fusion/core/lh_transition.py`
...
### 21. [P1] Harden `src/scpn_fusion/core/locked_mode.py`
...
### 22. [P1] Harden `src/scpn_fusion/core/momentum_transport.py`
...
### 23. [P1] Harden `src/scpn_fusion/core/neoclassical.py`
...
### 24. [P1] Harden `src/scpn_fusion/core/neural_turbulence.py`
...
### 25. [P1] Harden `src/scpn_fusion/core/plasma_wall_interaction.py`
...
### 26. [P1] Harden `src/scpn_fusion/core/stellarator_geometry.py`
...
### 27. [P1] Harden `src/scpn_fusion/core/vmec_lite.py`
