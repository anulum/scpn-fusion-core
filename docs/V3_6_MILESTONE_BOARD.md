...
| A04 | Data | P0 | Expand disruption real-shot manifest and provenance fields | Versioned shot manifest with source/license/proc hash | Provenance audit passes for all shots | Validation WG | Backlog |
...
| A18 | Documentation | P0 | Reconcile README/RESULTS/VALIDATION version consistency | Versioned claim tables with artifact pointers | Zero stale version tags in release docs | Docs WG | Backlog |
| A19 | Documentation | P1 | Add claim-to-artifact map page for all headline metrics | `docs/CLAIMS_EVIDENCE_MAP.md` | Every tracked claim resolves to artifact path | Docs WG | Backlog |
