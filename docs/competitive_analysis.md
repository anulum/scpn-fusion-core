...
|------|-------------|-------------|----------|--------|
| **SCPN v3.8.3 (Rust)** | **10--30 kHz** | **11.9 us P50 / 23.9 us P99** | Rust + Python | CI Criterion |
...
| **SCPN v3.8.3 (Rust)** | 1.5D step | **1.5--5.5 us per step** | Crit-gradient + neoclassical | CI Criterion |
| **SCPN v3.8.3 (MLP)** | Neural surrogate | **24 ns single-point** | Trained surrogate | CI Criterion |
...
| **SCPN v3.8.3 (Rust)** | 65x65 | Picard + SOR | **~100 ms** | Measured |
| **SCPN v3.8.3 (Neural)** | 129x129 | PCA + MLP surrogate | **0.39 ms mean** | CI verified |
| **SCPN v3.8.3 (Multigrid)** | 65x65 | V-cycle | **~15 ms** | Projected |
