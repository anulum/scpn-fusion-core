...
| **SCPN v3.9.3 (Rust)** | 1.5D step | **1.5--5.5 us per step** | Crit-gradient + neoclassical | CI Criterion |
| **SCPN v3.9.3 (MLP)** | Neural surrogate | **24 ns single-point** | Trained surrogate | CI Criterion |
...
| Free-boundary solve | **Yes (Green's function + coil opt)** | Partial | No | Yes | Yes | No |
