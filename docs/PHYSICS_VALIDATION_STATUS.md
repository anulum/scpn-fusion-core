...
| `fno_eurofusion_jet` | 2026-02-16 | rel_L2=0.79 | No (retired, non-default) |
...
The FNO weight is retired from default use (v4.0 decision: retrain on real
gyrokinetic data or remove).
...
| FNO turbulence | Synthetic Hasegawa-Wakatani | **No** (retired, non-default) |
