...
matrix, blocked sourced-Maxwell contract, time-resolved 5D current/charge moment histories plus spectral continuity-proxy evidence while self-consistent sourced field coupling remains blocked,
