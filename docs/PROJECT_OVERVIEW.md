...
| Static inventory | 13 Rust crates, 343 Python capability modules, 622 Python test files, and 64 public documentation pages | `docs/_generated/capability_snapshot.md` |
