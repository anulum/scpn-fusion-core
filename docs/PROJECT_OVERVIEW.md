...
| Static inventory | 13 Rust crates, 361 Python capability modules, 662 Python test files, and 70 public documentation pages | `docs/_generated/capability_snapshot.md` |
