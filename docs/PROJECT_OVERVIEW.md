...
| Static inventory | 13 Rust crates, 361 Python capability modules, 660 Python test files, and 68 public documentation pages | `docs/_generated/capability_snapshot.md` |
