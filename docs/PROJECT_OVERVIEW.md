...
| Static inventory | 13 Rust crates, 335 Python capability modules, 613 Python test files, and 64 public documentation pages | `docs/_generated/capability_snapshot.md` |
