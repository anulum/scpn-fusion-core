...
| Static inventory | 13 Rust crates, 361 Python capability modules, 655 Python test files, and 66 public documentation pages | `docs/_generated/capability_snapshot.md` |
