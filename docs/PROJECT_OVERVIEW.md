...
| Static inventory | 13 Rust crates, 356 Python capability modules, 637 Python test files, and 64 public documentation pages | `docs/_generated/capability_snapshot.md` |
