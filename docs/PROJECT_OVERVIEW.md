...
| Static inventory | 13 Rust crates, 339 Python capability modules, 620 Python test files, and 64 public documentation pages | `docs/_generated/capability_snapshot.md` |
