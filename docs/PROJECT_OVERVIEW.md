...
| Static inventory | 13 Rust crates, 361 Python capability modules, 661 Python test files, and 69 public documentation pages | `docs/_generated/capability_snapshot.md` |
