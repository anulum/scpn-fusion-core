...
| Static inventory | 13 Rust crates, 322 Python capability modules, 599 Python test files, and 63 public documentation pages | `docs/_generated/capability_snapshot.md` |
