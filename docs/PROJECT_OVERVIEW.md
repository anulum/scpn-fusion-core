...
| Static inventory | 13 Rust crates, 336 Python capability modules, 617 Python test files, and 64 public documentation pages | `docs/_generated/capability_snapshot.md` |
