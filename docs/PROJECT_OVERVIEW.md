...
| Static inventory | 13 Rust crates, 327 Python capability modules, 609 Python test files, and 64 public documentation pages | `docs/_generated/capability_snapshot.md` |
