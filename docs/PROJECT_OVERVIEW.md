...
| Static inventory | 13 Rust crates, 356 Python capability modules, 638 Python test files, and 64 public documentation pages | `docs/_generated/capability_snapshot.md` |
