...
| Static inventory | 13 Rust crates, 361 Python capability modules, 648 Python test files, and 65 public documentation pages | `docs/_generated/capability_snapshot.md` |
