...
| Static inventory | 13 Rust crates, 323 Python capability modules, 604 Python test files, and 63 public documentation pages | `docs/_generated/capability_snapshot.md` |
