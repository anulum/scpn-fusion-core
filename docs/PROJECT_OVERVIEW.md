...
| Static inventory | 13 Rust crates, 334 Python capability modules, 612 Python test files, and 64 public documentation pages | `docs/_generated/capability_snapshot.md` |
