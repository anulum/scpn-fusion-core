...
fn main() {
    ...
    for (idx, n) in grids.iter().enumerate() {
        ...
        print!(
            "{{\"grid_points\":{},\"wall_time_s\":{:.12e},\"r_null_m\":{:.17e},\"s_parameter\":{:.17e},\"energy_j_per_m\":{:.17e},\"pressure_balance_ratio\":{:.17e},\"force_balance_residual_linf\":{:.17e},\"b_z_checksum\":{:.17e},\"psi_checksum\":{:.17e},\"p_checksum\":{:.17e}}}",
            n,
            wall_time_s,
            state.r_null,
            state.s_parameter,
