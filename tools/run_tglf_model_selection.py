...
# SCPN Fusion Core — TGLF Surrogate Model Selection CLI
"""Run the frozen TGLF candidate-family study without promoting a model."""
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        action="append",
        required=True,
        help="Internal pre-fit lock or amendment; repeat in chronological order",
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        written = write_tglf_model_selection_report(report, output)
