...
- Enforce complete public API documentation in the `fusion-gpu` and
  `fusion-polyglot` crates and document their grid, adapter-selection,
  data-layout, parser, numerical-operator, and failure contracts.
