...
| 3.11.0  | :white_check_mark: | Previous stable - control/transport/surrogate/equilibrium feature wave (safety shield, TGLF surrogate, M-1, F-5, F-1) with modular-decomposition and validation-evidence passes |
