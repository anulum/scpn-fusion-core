...
the solver and validation entry points and re-exports the data contracts and
shared closures from the ``frc_rigid_rotor_contracts`` and
``frc_rigid_rotor_closures`` submodules so the historical import surface stays
byte-identical.
"""
