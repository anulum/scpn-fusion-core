...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "PBKBMPedestalModel": (".eped_pb_kbm", "PBKBMPedestalModel"),
    "PBKBMPedestalResult": (".eped_pb_kbm", "PBKBMPedestalResult"),
    "predict_pedestal": (".eped_pb_kbm", "predict_pedestal"),
    "GEqdsk": (".eqdsk", "GEqdsk"),
    ...
    "registered_gk_solvers": (".gk_registry", "registered_gk_solvers"),
    "resolve_tglf_solver": (".gk_registry", "resolve_tglf_solver"),
