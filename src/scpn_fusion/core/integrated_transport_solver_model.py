...
from scpn_fusion.core._integrated_transport_solver_model_backend import (
    TransportSolverBackendMixin,
)
from scpn_fusion.core._integrated_transport_solver_model_common import _solver_module
from scpn_fusion.core._integrated_transport_solver_model_pedestal import (
    TransportSolverPedestalMixin,
)
...
class TransportSolverModelMixin(TransportSolverBackendMixin, TransportSolverPedestalMixin):
    ...
    def update_transport_model(self, P_aux: float) -> None:
        ...
        chi_turb_e, chi_turb_i, d_turb = self._compute_transport_backend_closure(
            ...
            chi_base=chi_base,
            chi_base_source=chi_base_source,
            chi_gb_reference=chi_gb_reference,
            q_profile=q_profile,
        ...
        chi_turb_e, chi_turb_i, d_turb = self._apply_transport_pedestal_modifier(
            P_aux=P_aux,
