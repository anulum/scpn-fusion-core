...
\begin{enumerate}
  ...
  \item \textbf{Solov'ev-derived boundary conditions.}  The
    ...
    boundary.  While the free-boundary extension (v3.4.0) computes
...
licence.  The version described in this work corresponds to release v3.4.0.
