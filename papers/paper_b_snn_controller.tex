...
As of v3.3.0, the full \scpn{} test suite comprises 1419 passing tests
...
Since the initial release, the framework has grown to v3.3.0 with
...
\url{https://github.com/anulum/scpn-fusion-core}, release v3.3.0.  The
