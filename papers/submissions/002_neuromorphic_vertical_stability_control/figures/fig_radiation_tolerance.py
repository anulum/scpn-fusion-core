...
L = 1024-bit stream change the value by at most N/L.  In a normalized unsigned
32-bit register, flipping the N highest-order bits changes the represented value
by a fraction 1 - 2^-N.  Encoding robustness is not a closed-loop stabilisation
or radiation-tolerance claim.
...
def main():
    ...
    plt.close(fig)
    print('  [OK] fig_radiation_tolerance (analytical value-error illustration)')
