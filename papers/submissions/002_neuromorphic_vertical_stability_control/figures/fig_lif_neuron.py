...
def main():
    ...
    # Phase annotations
    phases = [
        (12.5, V_th - 0.09, 'Sub-threshold'),
        (35, V_th + 0.22, 'Regular spiking'),
        (60, V_th + 0.22, 'Ramp response'),
        (82, V_th + 0.22, 'Burst'),
    ]
    for x_pos, y_pos, label in phases:
        ax1.text(x_pos, y_pos, label, ha='center', va='bottom',
